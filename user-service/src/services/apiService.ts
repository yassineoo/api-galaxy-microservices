...
export default class apiService{
    ...
    static async getAllApis(user_id:number,limit:any,page:any,search:any){
        try {
            
            const res = await APIModel.getAPIS(user_id,limit,page,search)
            //console.log(res)
            return res
        } catch (error) {
            throw error
    ...
    static async getApisFoAdmin(admin_id:number,page:any,limit:any,search:any){
        try {
            const apis = await APIModel.getAPIListForAdmin(admin_id,page,limit,search)
            return apis
        } catch (error) {
            throw error
        }
    ...
    static async reportAnComment(reason:string,description:string,user_id:number,comment_id:number){
        try {
            const success = await ReviewModel.reportAnComment(comment_id,user_id,reason,description)
            return success
        } catch (error) {
            throw error 
        }
