...
export const likeApi = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const dislikeApi = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        const { api_id } = req.params
        const userId = req.userId
        if (!userId || !api_id) {
...
export const getAllApis = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const getAPIReview = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const getUserFollowingsApis = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        const { userId } = req.params
        if (!userId) {
            throw new SystemError("something went wrong")
...
export const reportAnAPI = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        const { apiId } = req.params
...
export const reportAnComment = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
...
export const getReviwesReports = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
        const { limit, page, search } = req.query
...
export const deleteReportReview = async (req: AuthRequest, res: Response, next: NextFunction) => {
    try {
