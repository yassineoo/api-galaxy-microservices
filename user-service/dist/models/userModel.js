...
userModel.AddUser = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield prisma_1.prismaClientSingleton.user_entities.create({
            data: {
...
userModel.updateUser = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const updatedUser = yield prisma_1.prismaClientSingleton.user_entities.update({
            where: {
                id: id,
            },
            data: data,
...
userModel.getUserById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield prisma_1.prismaClientSingleton.user_entities.findUnique({
            where: {
                id: id,
            },
        });
...
userModel.getAllUsers = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const users = yield prisma_1.prismaClientSingleton.user_entities.findMany();
        if (users.length === 0) {
...
userModel.deleteUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transaction = yield prisma_1.prismaClientSingleton.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
...
userModel.setLastLogin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield prisma_1.prismaClientSingleton.user_entities.update({
            where: {
                id,
            },
            data: {
...
userModel.isUserExist = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield prisma_1.prismaClientSingleton.user_entities.findUnique({
            where: {
                id,
