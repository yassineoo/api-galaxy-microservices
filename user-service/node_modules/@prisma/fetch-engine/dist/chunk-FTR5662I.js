...
var chunk_FTR5662I_exports = {};
__export(chunk_FTR5662I_exports, {
  download: () => download,
...
module.exports = __toCommonJS(chunk_FTR5662I_exports);
var import_chunk_4LX3XBNY = require("./chunk-4LX3XBNY.js");
var import_chunk_MX3HXAU2 = require("./chunk-MX3HXAU2.js");
var import_chunk_VQPMQ44G = require("./chunk-VQPMQ44G.js");
var import_chunk_NJSUFXSP = require("./chunk-NJSUFXSP.js");
var import_chunk_AZKAIDG4 = require("./chunk-AZKAIDG4.js");
...
var require_stream = (0, import_chunk_AH6QHEOA.__commonJS)({
  "../../node_modules/.pnpm/execa@5.1.1/node_modules/execa/lib/stream.js"(exports, module2) {
    "use strict";
    var isStream = (0, import_chunk_NJSUFXSP.require_is_stream)();
...
var import_fs_extra = (0, import_chunk_AH6QHEOA.__toESM)((0, import_chunk_AZKAIDG4.require_lib)());
var import_p_filter = (0, import_chunk_AH6QHEOA.__toESM)(require_p_filter());
var import_temp_dir = (0, import_chunk_AH6QHEOA.__toESM)((0, import_chunk_NJSUFXSP.require_temp_dir)());
...
async function download(options) {
  ...
  if (binariesToDownload.length > 0) {
    const cleanupPromise = (0, import_chunk_VQPMQ44G.cleanupCache)();
    let finishBar;
    let setProgress;
    ...
    const promises = binariesToDownload.map((job) => {
      const downloadUrl = (0, import_chunk_AZKAIDG4.getDownloadUrl)({
        channel: "all_commits",
...
async function binaryNeedsToBeDownloaded(job, nativePlatform, version) {
  ...
  if (cachedFile) {
    if (job.skipCacheIntegrityCheck === true) {
      await (0, import_chunk_AZKAIDG4.overwriteFile)(cachedFile, job.targetFilePath);
      return false;
    }
...
async function getCachedBinaryPath({
  ...
  const cacheDir = await (0, import_chunk_AZKAIDG4.getCacheDir)(channel, version, binaryTarget2);
  if (!cacheDir) {
    return null;
  }
...
async function downloadBinary(options2) {
  ...
  const { sha256, zippedSha256 } = await (0, import_chunk_NJSUFXSP.downloadZip)(downloadUrl, targetFilePath, progressCb);
  if (progressCb) {
    progressCb(1);
  }
...
async function saveFileToCache(job, version, sha256, zippedSha256) {
  const cacheDir = await (0, import_chunk_AZKAIDG4.getCacheDir)(channel, version, job.binaryTarget);
  if (!cacheDir) {
    return;
  }
  ...
  try {
    await (0, import_chunk_AZKAIDG4.overwriteFile)(job.targetFilePath, cachedTargetPath);
    if (sha256 != null) {
