...
var chunk_VQPMQ44G_exports = {};
__export(chunk_VQPMQ44G_exports, {
  cleanupCache: () => cleanupCache
});
module.exports = __toCommonJS(chunk_VQPMQ44G_exports);
...
async function cleanupCache(n = 5) {
  try {
    const rootCacheDir = await (0, import_chunk_AZKAIDG4.getRootCacheDir)();
    if (!rootCacheDir) {
