...
export class NotificationService {
  ...
  async create(createNotificationDto: CreateNotificationDto) {
    if(createNotificationDto.recipient_id==0){
      ...
      console.log("called from null",createNotificationDto.message,createNotificationDto.title)
...
*/
  ...
  async sendNotification(id: number) {
    ...
    console.log(`Sending notification: ${notification.title} to recipient ID ${notification.recipient_id}`);
  }
}
